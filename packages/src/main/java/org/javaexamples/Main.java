...
// Package is way to organize classes with a same/similar purpose
// Package is referred to a directory, in which the classes are stored

// This example is the same that Inheritance, but we have stored
// Person, Customer and Employee classes
// Classes from org.javaexamples.person package are imported for their usage
